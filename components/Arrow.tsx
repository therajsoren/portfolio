  ...
  return (
    <div className="absolute -top-20 -left-10  md:-left-10 flex flex-col items-center">
      ...
      <svg
        ...
        viewBox="0 0 256 256"
        fill="currentColor"
        className="text-slate-900 dark:text-slate-400 -mt-2 -rotate-12"
      >
        <g
          className="stroke: none; stroke-width: 0; stroke-dasharray: none; strokeLinecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;"
          transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)"
        >
          <path
            d="M 80.224 73.891 c -0.049 0.007 -0.095 0.029 -0.145 0.029 c -0.029 0 -0.055 -0.014 -0.084 -0.017 c -0.038 -0.001 -0.073 0.012 -0.111 0.006 c -0.064 -0.009 -0.117 -0.042 -0.176 -0.063 c -0.007 -0.003 -0.013 -0.004 -0.019 -0.007 c -0.21 -0.078 -0.383 -0.211 -0.498 -0.393 l -8.733 -8.734 c -0.391 -0.391 -0.391 -1.023 0 -1.414 s 1.023 -0.391 1.414 0 l 7.41 7.411 c 1.64 -15.449 -4.181 -28.442 -16.193 -35.847 c -0.471 -0.29 -0.617 -0.906 -0.327 -1.376 s 0.906 -0.616 1.376 -0.326 C 75.44 40.125 81.578 51.72 81.578 65.636 c 0 1.505 -0.08 3.04 -0.225 4.596 l 6.934 -6.934 c 0.391 -0.391 1.023 -0.39 F1 1.414 0 c 0.195 0.195 0.293 0.451 0.293 0.707 c 0 0.256 -0.098 0.512 -0.293 0.707 l -8.914 8.914 c -0.131 0.131 -0.298 0.204 -0.475 0.247 C 80.283 73.882 80.254 73.885 80.224 73.891 z"
            className="stroke: none; stroke-width: 1; stroke-dasharray: none; strokeLinecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1;"
